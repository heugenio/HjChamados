    ...
    <div class="col-xs-12 col-sm-12 col-md-12">
        <form id="form-cad-user" class="form-horizontal">    
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" maxlength="50" class="form-control" name="nome" id="inputNome" placeholder="Nome" value="${usuario.nome}">
                </div>
            </div>    
            <div class="form-group">
                <label for="inputLogin" class="col-sm-2 control-label">Login</label>
                <div class="col-sm-10">
                    <input type="text" maxlength="50" class="form-control" name="login" id="inputLogin" placeholder="Login" value="${usuario.login}">
                </div>
            </div>    
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="email" maxlength="50" class="form-control" name="email" id="inputEmail3" placeholder="Email" value="${usuario.email}">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="password" maxlength="10" class="form-control" name="senha" id="inputPassword3" placeholder="Senha" value="${usuario.senha}">
                </div>
            </div>
