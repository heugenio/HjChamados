...
<div class="modal fade" id="msg" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div id="divBtns" class="modal-footer">
                <button id="btn1" type="button" class="btn btn-primary"></button>
                <button id="btn2" type="button" class="btn btn-default" data-dismiss="modal"></button>
            </div>
        </div>
    </div>
</div>
